...
- Brave browser users can directly visit [HappyNews.DAO](https://gateway.pinata.cloud/ipfs/QmVupEsAY6m5qZuQrR6ym7V8zE4rpGhwzM4ECvKyY3zovA/index.html) without the need for any additional extensions. If you don't have the Brave browser, you can download it from the official website: [Download Brave Browser](https://brave.com/)
